  ...
  <div class="mob-accordion">
    ...
    <div class="mob-accordion-content">
      ...
      <div class="mob-accordion" style="border-bottom:none !important; display:block !important;">
        ...
        <div class="mob-accordion-content" style="background: #f1f5f9 !important;">
          <a href="prmaas.html" class="mob-sub-link" style="padding-left: 40px !important;"><span style="display:inline-block; width:6px; height:6px; border-radius:50%; background:#10b981; margin-right:12px;"></span> PRMaaS</a>
          <a href="pcmaas.html" class="mob-sub-link" style="padding-left: 40px !important;"><span style="display:inline-block; width:6px; height:6px; border-radius:50%; background:#10b981; margin-right:12px;"></span> PCMaaS</a>
        </div>
      </div>
    </div>
  </div>
